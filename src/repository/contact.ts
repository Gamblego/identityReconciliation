...
export class Contact {
  ...
  async getAllByEmailOrPhoneNumber(email?: String, phoneNumber?: String) {
    const whereClause = !email ? `c2.phoneNumber = '${phoneNumber}'` :
      !phoneNumber ? `c2.email = '${email}'` :                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
        ...
        // TODO: refactor query
        let query = 'SELECT * FROM contact c1 WHERE EXISTS ' + 
        '(SELECT * FROM contact c2 WHERE ' + 
        '(c1.id = c2.id OR c1.id = c2.linkedId OR c1.linkedId = c2.linkedId OR c1.linkedId = c2.id) AND ' + 
        whereClause + ')';
  ...
  async updateAllByLinkedId(parentId: Number, childId: Number) {
    ...
    let [result, fields]: any[] = await connection.query(
